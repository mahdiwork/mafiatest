...
def CreateDatabase():
    import mysql.connector
    config = {'user': 'root', 'password': 'ma8h2dii', 'host': 'localhost', 'charset':'utf8mb4'}
...
if __name__ == "__main__":
    ...
    insert_roles( 'rosta',           'village', "روستایی‌ساده👨🏻", 1)
    insert_roles( 'shekar',          'village', "شکارچی💂🏻‍♂️", 0)
    insert_roles( 'pishgo',          'village', "پیشگو👳🏻‍♂️", 0.4)
    insert_roles( 'kalantar',        'village', "کلانتر👮🏻‍♂️", 0.5)
    insert_roles( 'tofangdar',       'village', "تفنگدار🔫", 1)
    insert_roles( 'fereshte',        'village', "فرشته‌ی نگهبان👼🏻", 0.6)
