...
#-----------------------------------------------------callback---------------------------------------------------------
@bot.callback_query_handler(func=lambda call: call.data.startswith("kalantar"))
def edite_infi_cust(call):
    ...
    if data[1] == 'noshot':
        ...
        game_check = instans_game.noshotkalantar(instans_player)
        bot.edit_message_text(dict_messages_general['SelectOk_no'], cid, mid)
        ...
        instans_game = instans_player.game
        game_check = instans_game.shotkalantar(instans_player, instans_target)
